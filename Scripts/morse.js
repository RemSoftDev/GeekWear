...
(function (root) {
    ...
    // Save the previous value of the `morsejs` variable.
    var previousMorjs = root.morsejs;
    ...
    var morsejs = {
        ...
        decode: function (message, options) {
            message = message || '';
            options = getOptions(options, morsejs.defaults);
        ...
        // Run mor.js in *noConflict* mode, returning the `morsejs` variable to its previous owner.
        // Returns a reference to `morsejs`.
        noConflict: function () {
            root.morsejs = previousMorjs;

            return this;
        }
    };

    // Export `morsejs` for NodeJS and CommonJS.
    if (typeof exports !== 'undefined') {
        if (typeof module !== 'undefined' && module.exports) {
            exports = module.exports = morsejs;
        }

        exports.morsejs = morsejs;
    } else if (typeof define === 'function' && define.amd) {
        define(function () {
            return morsejs;
        });
    } else {
        root.morsejs = morsejs;
    }
})(window);
