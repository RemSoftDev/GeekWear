...
namespace GeekWear.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		[AllowAnonymous]
		[ValidateAntiForgeryToken]
		public async Task<ActionResult> ResendEmailConfirmation(ResendEmailConfirmation model)
		{
			if (ModelState.IsValid)
			{
				model.Confirmed = true;
				await ResendConfirmEmail(model.Email);
			}
			return View(model);
		}
		...
		private async Task ResendConfirmEmail(string email)
		{
